...
public class MarsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s1=getString(R.string.map1);
        String s2=getString(R.string.map1);
        String s3=getString(R.string.map1);
        ...
        bspeak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp= MediaPlayer.create(getApplicationContext(), R.raw.p4);
                mp.start();
            }
        });
